...
```typescript
import type { SeriesGroup, HistoryEntry, HomepageStatus } from './types';
...
<script lang="ts">
  ...
  interface Props {
    runtime: {
      ...
      handleSelectAlbum: (
        album: import('$lib/types').Album
      ) => void | Promise<void>;
      handlePlay: (
        song: import('$lib/types').SongEntry
      ) => void | Promise<void>;
